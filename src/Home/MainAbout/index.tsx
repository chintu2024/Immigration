                     ...
                     <div className="row">
                       <div className="col-md-6">
                         ...
                         <Typography
                           ...
                           className="mb-4"
                         >
                           Explore more than 100 immigration possibilities to Canada for
                           skilled workers, international students, and entrepreneurs.
                           Consider relocating with your loved ones to Canada in the year
                           2024.
                         </Typography>
                       </div>
                         ...
                         <div className="linkTab">
                           <ul>
                             {[...Array(4)].map((item, index) => (
                               <li key={index}>
                                 <a href="javascript:viod(0)">High-skilled workers Visa</a>
                               </li>
                             ))}
                           </ul>
                         </div>
