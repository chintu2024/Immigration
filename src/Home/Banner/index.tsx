        ...
        <div className="row">
          <div className="col-md-6 offset-md-6">
            ...
            >
              ...
              tailored options for Business, Study, and Family and Economic
              Immigration.
            </Typography>
            <div className="BookingBtn">
              <a href="javascript:viod(0);">Book a Consultion <img src="images/arrows-arrow-up-right.svg" width={30}/></a>
            </div>
            </div>
        </div>
      </div>
